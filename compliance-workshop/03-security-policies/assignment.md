...
💡 **In kubernetes world, labels are essential to connect identifying metadata with Kubernetes objects.**
...
===============
To perform the microsegmentation we will need to know more about how hipstershop communicates between the services. The following diagram provides the information we need to know:
...
Now you want to try to access redis-cart from an unauthorized pod in the hipstershop namespace (i.e. checkoutservice).
